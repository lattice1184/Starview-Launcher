...
public static class ThirdPartyLicenses
{
    ...
    [
        ...
        // 8-30 UI 弱化（用户拍板）：关于页不露 BlockHelm-Launcher 名字，只提陶瓦协议；完整来源声明保留在仓库 NOTICE（GPL-3.0 合规义务由 NOTICE 承担）
        "联机模块基于陶瓦（Terracotta）联机协议集成，依据 GPL-3.0 许可；运行时联机内核同依据 GPL-3.0（来源声明见仓库 NOTICE）。",
