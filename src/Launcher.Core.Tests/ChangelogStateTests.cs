...
public class ChangelogStateTests
{
    ...
    public void GroupsAfter_ReturnsNewerNamedGroupsOnly()
    {
        ...
        Assert.Equal(7, g.Count); // v1.1.15 + v1.1.14 + v1.1.13 + v1.1.11 + v1.1.10 + v1.1.9 + v1.1.8（最新在前）
        Assert.Equal("v1.1.15", g[0].Version);
        Assert.Equal("v1.1.14", g[1].Version);
    ...
    public void GroupsAfter_Empty_ForNullOrLatest()
    {
        ...
        Assert.Empty(ChangelogCatalog.GroupsAfter("1.1.15")); // 已是最新：无更新
    }
}
